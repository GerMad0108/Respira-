...
bPrev.addEventListener("click", (e) => {
  ...
  if (current !== changed) {
    renderCurrentVideo(video<s[current].id);
  }
});
...
function renderCurrentVideo(id) {
  currentContainer.innerHTML = `<iframe width="100%" height="480" src="https://www.youtube.com/embed/$[{id}" title="Purificador de Aire Philips - Serie 3000i" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`;
}
